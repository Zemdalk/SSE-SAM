...
import sklearn
from utils.datasets_LT import *
    
def print_accuracy(model, dataloaders, new_labelList, epoch, dataset = 'cifar100', device = 'cpu', test_aug = True, save_dir = None):
    model.eval()
    ...
    if dataset == 'cifar100':
        ...
        breakdownResults = shot_acc(predList, grndList, np.array(new_labelList), many_shot_thr=1000, low_shot_thr=200, acc_per_cls=False)
